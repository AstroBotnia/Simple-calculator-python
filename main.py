...
buttonequal=tk.Button(cal,text="=",font=("arial",20,"bold"),bd=5,padx=135,command=sum)
buttonequal.grid(row=5,columnspan=4)
...
buttonmul=tk.Button(cal,text="*",font=("arial",20,"bold"),bd=5,padx=13,command=lambda:click("*"))
buttonmul.grid(row=4,column=3)

buttondot=tk.Button(cal,text=".",font=("arial",20,"bold"),bd=5,padx=14,command=lambda:click("."))
buttondot.grid(row=4,column=0)

buttonclear=tk.Button(cal,text="C",font=("arial",20,"bold"),bd=5,padx=7,command=clear)
